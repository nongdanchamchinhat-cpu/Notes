<p align="center">
<img style="align:center;" src="/resources/screenshots/web.jpg" alt="OpenNotes web screenshot" width="600" />
</p>

<h1 align="center">OpenNotes Web</h1>
<h3 align="center">The web app is built using React, Typescript & Javascript.</h3>
<p align="center">
<a href="https://app.opennotes.openlay.com/">Try it out!</a> | <a href="#developer-guide">Developer guide</a> | <a href="#build-instructions">How to build?</a> | <a href="../desktop/">Desktop app</a>
</p>
...
```bash
git clone https://github.com/openlay/opennotes.git

# change directory
cd opennotes
```

Once you are inside the `./opennotes` directory, run the preparation step:
...
1. `src/`: 99% of the source code lives here & this is also where you'll spend most of your time.
   ...
   7. `interfaces/`: This is where the **platform-specific storage & encryption logic** lives. These interface implementations are used by the `@opennotes/core` to provide capabilities such as persistence & encryption.
