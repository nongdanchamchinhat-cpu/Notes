...
export function getDownloadLink(platform: string) {
  const baseurl = `https://opennotes.openlay.com/releases/${platform.toLowerCase()}`;
  switch (platform) {
    case "iOS":
      return [
        {
          type: "Install from App Store",
          link: "https://apps.apple.com/pk/app/opennotes-take-private-notes/id1544027013"
        }
      ];
    case "Android":
      return [
        {
          ...
          link: "https://play.google.com/store/apps/details?id=com.openlay.opennotes"
        },
        {
          type: "Download .apk (arm64-v8a)",
          link: `${baseurl}/opennotes-arm64-v8a.apk`
        },
        {
          type: "Download .apk (armeabi-v7a)",
          link: `${baseurl}/opennotes-armeabi-v7a.apk`
        },
        {
          type: "Download .apk (x86)",
          link: `${baseurl}/opennotes-x86.apk`
        },
        {
          type: "Download .apk (x86_64)",
          link: `${baseurl}/opennotes-x86_64.apk`
        }
      ];
    case "macOS":
      return [
        {
          ...
          link: `${baseurl}/opennotes_mac_x64.dmg`
        },
        {
          type: "Download .dmg (arm64)",
          link: `${baseurl}/opennotes_mac_arm64.dmg`
        }
      ];
    case "Windows":
      return [
        {
          ...
          link: `${baseurl}/opennotes_win_x64.exe`
        },
        {
          type: "Download portable .exe (x64)",
          link: `${baseurl}/opennotes_win_x64_portable.exe`
        }
      ];
    case "Linux":
      return [
        {
          ...
          link: `${baseurl}/opennotes_linux_x86_64.AppImage`
        },
        {
          type: "Download .deb",
          link: `${baseurl}/opennotes_linux_amd64.deb`
        },
        {
          type: "Download .rpm",
          link: `${baseurl}/opennotes_linux_x86_64.rpm`
        }
      ];
    default:
      return [
        {
          type: "Download",
          link: "https://github.com/openlay/opennotes/releases/"
        }
      ];
  }
}
