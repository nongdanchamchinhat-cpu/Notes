        ...
        components: [
          {
            ...
            action: () => {
              window.open(
                "https://github.com/openlay/opennotes",
                "_blank"
              );
            },
        ...
        components: [
          {
            type: "button",
            action: () =>
              void window.open("https://opennotes.openlay.com/roadmap", "_blank"),
        ...
        components: [
          {
            ...
            action: () =>
              void window.open(
                isMacStoreApp()
                  ? "https://apps.apple.com/us/app/opennotes-take-private-notes/id1544027013"
                  : "https://opennotes.openlay.com/downloads",
                "_blank"
              ),
    ...
    settings: [
      {
        ...
        components: [
          {
            type: "button",
            action: () => void window.open("https://t.me/opennotes", "_blank"),
            title: strings.joinTelegram(),
            variant: "secondary"
          }
        ]
        ...
        components: [
          {
            type: "button",
            action: () =>
              void window.open("https://fosstodon.org/@opennotes", "_blank"),
        ...
        components: [
          {
            type: "button",
            action: () =>
              void window.open("https://twitter.com/opennotes", "_blank"),
            title: strings.follow(),
            variant: "secondary"
          }
        ]
        ...
        components: [
          {
            type: "button",
            action: () =>
              void window.open("https://opennotes.openlay.com/privacy", "_blank"),
            title: strings.open(),
            variant: "secondary"
          }
        ]
        ...
        components: [
          {
            type: "button",
            action: () =>
              void window.open("https://opennotes.openlay.com/terms", "_blank"),
            title: strings.open(),
            variant: "secondary"
          }
        ]
        ...
        components: [
          {
            ...
            action: () =>
              void window.open(
                "https://github.com/openlay/opennotes/blob/master/LICENSE",
                "_blank"
              ),
            title: strings.open(),
            variant: "secondary"
        ...
        components: [
          {
            type: "button",
            action: async () => {
              await navigator.clipboard.writeText("support@openlay.co");
              showToast("info", strings.copied());
            },
            title: strings.copy(),
            variant: "secondary"
          },
          {
            type: "button",
            action: () => {
              window.open("mailto:support@openlay.co", "_blank");
            },
            title: strings.send(),
            variant: "secondary"
          }
        ...
        components: [
          {
            type: "button",
            action: () =>
              void window.open("https://help.opennotes.openlay.com/", "_blank"),
            title: strings.open(),
            variant: "secondary"
          }
        ]
