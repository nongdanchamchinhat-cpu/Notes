...
import { Period, SubscriptionPlan } from "@opennotes/core";
...
import { getFeaturesTable, planToAvailability } from "@opennotes/common";
...
const FEATURED_ON = [
  ...
  },
  {
    id: "itsfoss",
    logo: ItsFoss,
    link: "https://news.itsfoss.com/standard-notes-to-opennotes/"
  },
  {
    id: "Hackernoon",
    logo: Hackernoon,
...
const RECOMMENDED_BY = [
  {
    ...
    logo: PrivacyGuides,
    size: 45,
    link: "https://www.privacyguides.org/en/notebooks/#opennotes"
  },
  {
    id: "techlore",
    logo: Techlore,
  ...
  },
  {
    ...
    link: "https://freedom.press/digisec/blog/note-taking-security/#opennotes"
  }
];
