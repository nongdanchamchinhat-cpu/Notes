...
import { Period, SubscriptionPlan, User } from "@opennotes/core";
import { BaseDialogProps, DialogManager } from "../../common/dialog-manager";
import dayjs from "dayjs";
import { PromptDialog } from "../prompt";
import IconTag from "../../components/icon-tag";
import { usePromise } from "@opennotes/common";
  ...
  return (
    <>
      ...
      <Text variant="body" mt={1} sx={{ textAlign: "center" }}>
        You already have a OpenNotes subscription. You can change your plan from
