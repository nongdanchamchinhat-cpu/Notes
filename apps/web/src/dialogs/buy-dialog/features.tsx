...
const sections: Section[] = [
  {
    ...
    detail:
      "Everything you do in OpenNotes stays private. We use XChaCha20-Poly1305-IETF and Argon2 to encrypt your notes.",
    features: [
      {
        id: "zero-ads",
  ...
  },
  {
    ...
    detail: "OpenNotes is available on all major platforms — for everyone.",
    columns: 8,
  ...
  {
    title: "Personalize & make OpenNotes your own",
    detail:
