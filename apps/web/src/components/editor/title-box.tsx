...
import { debounceWithId } from "@opennotes/common";
import { useEditorConfig, useEditorManager } from "./manager";
import { getFontById } from "@opennotes/editor";
import { replaceDateTime } from "@opennotes/editor";
import { useStore as useSettingsStore } from "../../stores/setting-store";
import { AppEventManager, AppEvents } from "../../common/app-events";
import { strings } from "@opennotes/intl";
import { NEWLINE_STRIP_REGEX } from "@opennotes/core";
