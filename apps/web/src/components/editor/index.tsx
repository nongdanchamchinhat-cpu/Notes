...
import { EVENTS } from "@opennotes/core";
import { db } from "../../common/db";
import Titlebox, { resizeTextarea } from "./title-box";
import Config from "../../utils/config";
import { ScopedThemeProvider } from "../theme-provider";
import { showToast } from "../../utils/toast";
import { Item, MaybeDeletedItem, isDeleted } from "@opennotes/core";
import { debounce, debounceWithId } from "@opennotes/common";
import { Freeze } from "react-freeze";
import { UnlockView } from "../unlock";
import DiffViewer from "../diff-viewer";
import TableOfContents from "./table-of-contents";
import { scrollIntoViewById } from "@opennotes/editor";
  ...
  return (
    <EditorChrome {...props}>
      <Tiptap
        ...
        content={content}
        downloadOptions={{
          corsHost: Config.get("corsProxy", "https://cors.opennotes.openlay.com")
        }}
        onLoad={(editor) => {
