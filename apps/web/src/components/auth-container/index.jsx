...
import { getRandom, usePromise } from "@opennotes/common";
...
import { hosts } from "@opennotes/core";
...
const testimonials = [
  {
    ...
    text: "Are you looking for an alternative to @evernote, or just looking for a more secure note taking platform? Take a look at @opennotes and see if it will fit your needs."
  },
  {
    ...
    text: "@opennotes app is what @evernote should have become long ago. And they're still improving."
  },
  {
    ...
    text: "I work in content writing and communications. My day starts and ends in OpenNotes. My Chrome app is always open; it's where I take all my notes. The clean design, focus mode, the tagging and color coding are all features that help keep my work organised every day."
  },
  {
    username: "camflint",
    image: Cameron,
    ...
    text: "I'm pretty impressed at the progress @opennotes are making on their app — particularly in respect to how performant the app runs and behaves, despite the overhead of end-to-end encrypting user data."
  }
];
