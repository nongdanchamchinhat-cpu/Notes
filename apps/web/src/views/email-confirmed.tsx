...
const social = [
  ...
  },
  {
    ...
    hoverColor: "#1da1f2",
    icon: Twitter,
    link: "https://twitter.com/opennotes"
  },
  {
    title: "Reddit",
    hoverColor: "#ff4500",
    icon: Reddit,
    link: "https://reddit.com/r/OpenNotes"
  }
];
function BlogPromoBanner() {
  return (
    ...
    >
      ...
      {/* <p>
        Listen. We want you to buy OpenNotes Pro. It's as simple as that. Since
      ...
      <p>
        We want you to buy OpenNotes Pro. Not to line our own pockets but to
        bring a change. Instead of. We want to hear that phrase. "I bought
        OpenNotes instead of Evernote". For us, that is success.
      </p>
      <p>
...
//         We started out building OpenNotes in November 2019. Our mission was to
