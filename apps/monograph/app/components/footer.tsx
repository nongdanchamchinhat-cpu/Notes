...
>;
const SOCIAL_LINKS = [
  { id: "X/Twitter", icon: mdiTwitter, href: "https://twitter.com/opennotes" },
  { id: "Reddit", icon: mdiReddit, href: "https://www.reddit.com/r/opennotes" },
  {
    id: "Telegram",
  ...
  },
  {
    id: "Mastodon",
    icon: mdiMastodon,
    href: "https://fosstodon.org/@opennotes"
  }
];
...
const footerLinks = [
  {
    title: "OpenNotes",
    type: "link",
    href: "https://opennotes.openlay.com"
  },
  {
    title: "Try for free",
    type: "link",
    href: "https://app.opennotes.openlay.com"
  },
  {
    title: "Blog",
    type: "link",
    href: "https://blog.opennotes.openlay.com/"
  },
  {
    title: "About",
    type: "link",
    href: "https://opennotes.openlay.com/about"
  }
];
    ...
    >
          ...
          >
            ...
            >
              ...
              <Text variant="subBody">
                {subtitle || "A product of OpenNotes"}
              </Text>
            </Flex>
          </Flex>
      ...
      >
        <Text variant="subBody" color="info">
          {new Date(Date.now()).getFullYear()} OpenLay (Private) Ltd.
        </Text>
        <Flex sx={{ gap: 2 }}>
          <Link variant="text.subBody" href="https://opennotes.openlay.com/privacy">
            Privacy Policy
          </Link>
          <Link variant="text.subBody" href="https://opennotes.openlay.com/terms">
            Terms of Service
          </Link>
        </Flex>
      </Flex>
