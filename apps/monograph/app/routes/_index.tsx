...
const features = [
  {
    name: "Share notes",
    body: `Share a note with anyone on the internet even if they do not use OpenNotes using a private sharable url.`,
      ...
      >
        ...
        >
          ...
          <ButtonLink
            ...
            href="https://help.opennotes.openlay.com/publish-notes-with-monographs"
            target="_blank"
          >
            How it works
          </ButtonLink>
