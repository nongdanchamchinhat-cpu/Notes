...
import { NNCrypto } from "@opennotes/crypto";
    ...
    >
      ...
      >
        <Text as="p" variant="body" sx={{ mx: 2 }}>
          Congratulations! You successfully verified OpenNotes&apos;s data
          encryption claims.
        </Text>
        <Text as="p" variant="body" sx={{ mx: 2, mt: 2 }}>
          Of course, this is just one part (a very crucial one) of proving that
          you can trust OpenNotes with your data. If you have any other
          preservations, let us know by reaching out to us at{" "}
          <Link href="mailto:support@openlay.co">
            support@openlay.co
          </Link>{" "}
          or{" "}
        ...
        <Text as="p" variant="body" sx={{ mx: 2, mt: 2, fontWeight: "bold" }}>
          What about open sourcing OpenNotes?
        </Text>
        <Text as="p" variant="body" sx={{ mx: 2, my: 2 }}>
          Open sourcing is another part of garnering our users&apos; trust. We
          have <Link href="https://opennotes.openlay.com/roadmap">plans</Link> to begin
