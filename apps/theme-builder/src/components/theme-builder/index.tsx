...
*/
import { debounce } from "@opennotes/common";
import {
  COLORS,
  ThemeAuthor,
  ThemeDefinition,
  ...
  validateTheme,
  ALPHA_COLORS
} from "@opennotes/theme";
import { Button, Flex, Input, Text } from "@theme-ui/components";
import FileSaver from "file-saver";
import { FormEventHandler, useCallback, useRef, useState } from "react";
import { useStore } from "@opennotes/web/src/stores/theme-store";
import { showToast } from "@opennotes/web/src/utils/toast";
import Accordion from "@opennotes/web/src/components/accordion";
import { showFilePicker, readFile } from "@opennotes/web/src/utils/file-picker";
import Field from "@opennotes/web/src/components/field";
import { Close } from "@opennotes/web/src/components/icons";
import { flatten, unflatten } from "../../utils/object";
import { version } from "../../../package.json";
import { writeText } from "clipboard-polyfill";
import { tryParse } from "@opennotes/web/src/utils/parse";
import { loadThemeFromJSON } from "../../utils/theme-loader";

const JSON_SCHEMA_URL =
  "https://raw.githubusercontent.com/openlay/opennotes-themes/main/schemas/v1.schema.json";
