...
module.exports = async function (configuration) {
  if (process.env.OPENNOTES_STAGING) return;

  const Endpoint = "https://weu.codesigning.azure.net";
  const CodeSigningAccountName = "OpenNotes";
  const CertificateProfileName = "OpenNotes";
  ...
  const Description = "The OpenNotes app";
  const DescriptionUrl = "https://opennotes.openlay.com/";
