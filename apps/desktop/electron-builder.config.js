...
const productName = process.env.NN_PRODUCT_NAME || "OpenNotes";
const appId = process.env.NN_APP_ID || "org.openlay.opennotes";
...
module.exports = {
  ...
  copyright: `Copyright © ${year} OpenLay (Private) Limited`,
  artifactName: "opennotes_${os}_${arch}.${ext}",
  ...
  portable: {
    artifactName: "opennotes_${os}_${arch}_portable.${ext}"
  },
  nsis: {
    oneClick: true,
