...
import { formatBytes } from "@opennotes/common";
import {
  SubscriptionPlan,
...
export const settingsGroups: SettingSection[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        id: "opennotes-circle",
        name: strings.opennotesCircle(),
        icon: "circle-outline",
        type: "screen",
        description: strings.opennotesCircleDesc(),
        component: "opennotes-circle"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        inputProperties: {
          defaultValue: "https://cors.opennotes.openlay.com",
          autoCorrect: false,
          keyboardType: "url"
        },
        property: "corsProxy",
      ...
      },
      {
        ...
        modifer: () => {
          ...
          if (Platform.OS === "ios") {
            ...
            OpenNotesModule.setSecureMode(!settings.privacyScreen);
          }
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        icon: "email",
        modifer: () => {
          Clipboard.setString("support@openlay.co");
          ToastManager.show({
          ...
          setTimeout(() => {
            Linking.openURL("mailto:support@openlay.co");
          }, 1000);
        },
      ...
      },
      {
        ...
        modifer: async () => {
          Linking.openURL("https://help.opennotes.openlay.com/");
        },
    ...
    sections: [
      {
        ...
        iconSize: 35,
        modifer: () => {
          Linking.openURL("https://t.me/opennotes").catch(() => {
            /* empty */
          });
        }
      },
      {
        ...
        icon: "mastodon",
        modifer: () => {
          Linking.openURL("https://fosstodon.org/@opennotes").catch(
            console.log
          );
        }
      },
      {
        ...
        icon: "twitter",
        modifer: () => {
          Linking.openURL("https://twitter.com/opennotes").catch(() => {
            /* empty */
          });
        }
      },
    ...
    sections: [
      {
        ...
        modifer: async () => {
          try {
            await Linking.openURL("https://opennotes.openlay.com/tos");
          } catch (e) {
            console.error(e);
          }
        },
      ...
      },
      {
        ...
        modifer: async () => {
          try {
            await Linking.openURL("https://opennotes.openlay.com/privacy");
          } catch (e) {
            console.error(e);
          }
        },
    ...
    sections: [
      {
        ...
        modifer: async () => {
          try {
            await Linking.openURL("https://opennotes.openlay.com/downloads");
          } catch (e) {
            console.error(e);
          }
        },
      ...
      },
      {
        ...
        modifer: async () => {
          try {
            await Linking.openURL("https://opennotes.openlay.com/roadmap/");
          } catch (e) {
            console.error(e);
          }
        },
      ...
      },
      {
        ...
        modifer: async () => {
          try {
            await Linking.openURL("https://opennotes.openlay.com");
          } catch (e) {
            console.error(e);
          }
        },
