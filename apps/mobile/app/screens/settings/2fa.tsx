...
import { sanitizeFilename, useIsFeatureAvailable } from "@opennotes/common";
import { strings } from "@opennotes/intl";
import { useThemeColors, VariantsWithStaticColors } from "@opennotes/theme";
          ...
          >
            ...
            <Button
              ...
              onPress={async () => {
                try {
                  let path;
                  let fileName = "opennotes_recoverycodes";
