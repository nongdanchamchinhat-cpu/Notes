...
*/
import { Note, VirtualizedGrouping } from "@opennotes/core";
...
const NoteItem = (props: {
  ...
  return (
    <TouchableOpacity
      activeOpacity={0.7}
      onPress={() => {
        const widgetId = OpenNotesModule.getWidgetId();
    ...
    >
      <Header
        ...
        onLeftMenuButtonPress={() => {
          OpenNotesModule.cancelAndFinish();
        }}
      />
