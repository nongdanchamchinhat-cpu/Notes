...
import { getFormattedDate, getTimeAgo } from "@opennotes/common";
import { HistorySession, Note, VirtualizedGrouping } from "@opennotes/core";
    ...
    <View>
      ...
      >
        ...
        <Text
          onPress={() => {
            openLinkInBrowser(
              "https://help.opennotes.openlay.com/note-version-history"
            );
          }}
          style={{
            color: colors.primary.accent,
