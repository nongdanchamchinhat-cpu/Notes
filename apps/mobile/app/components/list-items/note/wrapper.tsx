...
import { BaseTrashItem, Color, Note, Reminder } from "@opennotes/core";
...
import { NotebooksWithDateEdited, TagsWithDateEdited } from "@opennotes/common";
...
>(
  function NoteWrapper({
    ...
    return (
      <SelectionWrapper
        testID={opennotes.ids.note.get(index)}
