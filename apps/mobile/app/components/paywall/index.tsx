...
import { getFeaturesTable } from "@opennotes/common";
import {
  EV,
  EVENTS,
  Plan,
              ...
              >
                ...
                >
                  {pricingPlans.isSubscribed()
                    ? strings.changePlan()
                    : strings.opennotesPlans[0]() + " "}
                  {pricingPlans.isSubscribed() ? null : (
                    <Heading
                      size={AppFontSize.xl}
                      color={colors.primary.accent}
                    >
                      {strings.opennotesPlans[1]()}
                    </Heading>
                  )}
                </Heading>
              </View>
            ...
            >
              ...
              >
                ...
                <TouchableOpacity
                  onPress={() => {
                    openLinkInBrowser(
                      "https://github.com/openlay/opennotes/stargazers"
                    );
                  }}
                  activeOpacity={0.9}
                  style={{
                ...
                <TouchableOpacity
                  onPress={() => {
                    openLinkInBrowser(
                      "https://www.privacyguides.org/en/notebooks/#opennotes"
                    );
                  }}
                  activeOpacity={0.9}
                  style={{
...
After trying all the privacy security oriented note taking apps, for the price and the features afforded to your users, OpenNotes is hands down the best.`}
                />
              </View>
            </View>
            <View
  ...
  const product =
    plan.subscriptions?.[
      regionalDiscount?.sku ||
        `opennotes.${plan.id}.${annualBilling ? "yearly" : "monthly"}`
    ];
