...
import { hosts, Monograph, Note } from "@opennotes/core";
...
import { isFeatureAvailable, useIsFeatureAvailable } from "@opennotes/common";
        ...
        onPress={async () => {
          try {
            await openLinkInBrowser(
              "https://help.opennotes.openlay.com/publish-notes-with-monographs"
            );
          } catch (e) {
            console.error(e);
          }
