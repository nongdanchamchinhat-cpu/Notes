...
*/
import { Plan, SKUResponse } from "@opennotes/core";
      ...
      >
        {[
          Config.GITHUB_RELEASE === "true"
            ? "yearly"
            : `opennotes.${props.planId}.yearly`,
          Config.GITHUB_RELEASE === "true"
            ? "monthly"
            : `opennotes.${props.planId}.monthly`,
          ...(props.planId === "essential" || pricingPlans.isSubscribed()
            ? []
            : [
                Config.GITHUB_RELEASE === "true"
                  ? "5-year"
                  : `opennotes.${props.planId}.5year`
              ])
        ].map((item) => (
          <ProductItem
            key={item}
        ...
        >
          ...
          <Text
            ...
            onPress={() => {
              openLinkInBrowser("https://opennotes.openlay.com/privacy");
            }}
          >
            {strings.subTerms[1]()}
          </Text>{" "}
          ...
          <Text
            ...
            onPress={() => {
              openLinkInBrowser("https://opennotes.openlay.com/tos");
            }}
          >
            {strings.subTerms[3]()}
          </Text>
                ...
                {strings.percentOff(
                  (regionalDiscount
                    ...
                    : props.pricingPlans.compareProductPrice(
                        props.pricingPlans.currentPlan?.id as string,
                        `opennotes.${props.pricingPlans.currentPlan?.id}.yearly`,
                        `opennotes.${props.pricingPlans.currentPlan?.id}.monthly`
                      )) as string
                )}
              </Heading>
            </View>
