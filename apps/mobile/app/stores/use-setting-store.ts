...
import { ThemeDark, ThemeLight, ThemeDefinition } from "@opennotes/theme";
import { DayFormat, WeekFormat, Reminder } from "@opennotes/core";
...
export const defaultSettings: SettingStore["settings"] = {
  ...
  defaultSnoozeTime: "5",
  corsProxy: "https://cors.opennotes.openlay.com",
