...
import { logger as dbLogger, ICompressor } from "@opennotes/core";
...
export async function setupDatabase(password?: string) {
  ...
  //   OPENNOTES_HOST: `${base}:8788`
  // });

  database.host({
    API_HOST: "https://api.opennotes.openlay.com",
    AUTH_HOST: "https://auth.openlay.co",
    SSE_HOST: "https://events.openlay.co",
    SUBSCRIPTIONS_HOST: "https://subscriptions.openlay.co",
    ISSUES_HOST: "https://issues.openlay.co",
    MONOGRAPH_HOST: "https://monogr.ph",
    OPENNOTES_HOST: "https://opennotes.openlay.com",
