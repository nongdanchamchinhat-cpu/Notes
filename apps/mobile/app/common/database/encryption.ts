...
import { SerializedKey } from "@opennotes/crypto";
...
const IOS_KEYCHAIN_ACCESS_GROUP = "group.org.openlay.opennotes";
const IOS_KEYCHAIN_SERVICE_NAME = "org.openlay.opennotes";
const KEYCHAIN_SERVER_DBKEY = "opennotes:db";

const OPENNOTES_APPLOCK_KEY_SALT = "kBwr1Kre86ebOZ8ThLu2OA";
const OPENNOTES_DB_KEY_SALT = "SNuzOcEK3amoqL0WvPeKqw";
...
export async function getDatabaseKey(appLockPassword?: string) {
  ...
  if (await Keychain.hasInternetCredentials("opennotes")) {
