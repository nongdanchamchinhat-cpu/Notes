...
interface OpenNotesModuleInterface {
  ...
  getWidgetId: () => void;
  getIntent: () => {
    "com.openlay.opennotes.OpenNoteId"?: string;
    "com.openlay.opennotes.OpenReminderId"?: string;
    "com.openlay.opennotes.NewReminder"?: string;
  };
...
export const OpenNotesModule: OpenNotesModuleInterface = Platform.select({
  ios: {
    getActivityName: () => {},
    setBackgroundColor: () => {},
    setSecureMode: () => {},
