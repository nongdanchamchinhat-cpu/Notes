...
export const strings = {
  ...
  analyticsPermissionText: {
    0: () => t`Help improve OpenNotes by sending completely anonymized`,
  ...
  monographLearnMore: () => t`Learn more about OpenNotes Monograph`,
  rateAppHeading: () => t`Do you enjoy using OpenNotes?`,
  rateAppDesc: () =>
    t`It took us a year to bring OpenNotes to life. Share your experience and suggestions to help us improve it.`,
...
$day$: Current day (eg. Monday)`,
  ...
  issueDesc2: () =>
    t`Let us know if you have faced any issue/bug while using OpenNotes. We will try to fix it as soon as possible.`,
  migrationSaveBackup: () => t`Save a backup of your notes`,
  migrationSaveBackupDesc: () =>
    t`Thank you for updating OpenNotes! We will be applying some minor changes for a better note taking experience.`,
  ...
  subscriptionProviderInfo: {
    0: {
      type: "OpenLay",
      title: () => t`Subscription awarded from OpenLay`,
      desc: () =>
        t`You were awarded a subscription to OpenNotes Pro by OpenLay.`
    },
    1: {
      type: "iOS",
      title: () => t`Subscribed on iOS`,
      desc: () =>
        t`You subscribed to OpenNotes Pro on iOS using Apple In App Purchase. You can cancel anytime with your iTunes Account settings.`,
      icon: "ios"
    },
    2: {
      type: "Android",
      ...
      desc: () =>
        t`You subscribed to OpenNotes Pro on Android Phone/Tablet using Google In App Purchase.`,
      icon: "android"
    },
    3: {
      type: "Web",
      title: () => t`Subscribed on Web`,
      desc: () => t`You subscribed to OpenNotes Pro on the Web/Desktop App.`,
      icon: "web"
    },
    4: {
      type: "Gift card",
      title: () => t`Subscribed using gift card`,
      desc: () => t`You subscribed to OpenNotes Pro using a gift card.`
    }
  },
  dark: () => t`Dark`,
  light: () => t`Light`,
  ...
  fileSaved: (name: string, platform: string) =>
    select(platform, {
      ...
      other: `${name} saved to File Manager/OpenNotes/downloads`
    }),
  ...
  introData: [
    ...
    },
    {
      ...
      body: () =>
        t`Your privacy matters to us, no matter who you are. In a world where everyone is trying to spy on you, OpenNotes encrypts all your data before it leaves your device. With OpenNotes no one can ever sell your data again.`
    },
    {
      tesimonial: () =>
        t`You simply cannot get any better of a note taking app than @opennotes. The UI is clean and slick, it is feature rich, encrypted, reasonably priced (esp. for students & educators) & open source`,
  ...
  mfaEmailDesc: () =>
    t`OpenNotes will send you a 2FA code on your email when prompted`,
  mfaEmailSubtitle: () =>
  ...
  mfaSmsDesc: () =>
    t`OpenNotes will send you an SMS with a 2FA code when prompted`,
  ...
  opennotesPro: () => t`OpenNotes Pro`,
  subscribedOnVerify: (date: string) =>
    t`You subscribed to OpenNotes Pro on ${date}. Verify this subscription?`,
  verifySubscription: () => t`Verify subscription`,
  subscriptionVerifyWait: () =>
    t`Please wait while we verify your subscription`,
  verifySubDesc: () => t`Verify your subscription to OpenNotes Pro`,
  logoutWarnin: () =>
  ...
  forcePullChangesDesc: () =>
    [
      ...
      "",
      t`This must only be used for troubleshooting. Using it regularly for sync is not recommended and will lead to unexpected data loss and other issues. If you are having persistent issues with sync, please report them to us at support@openlay.co.`
    ].join("\n"),
  forceSyncNotice: () =>
    `This must only be used for troubleshooting. Using this regularly for sync is not recommended and will lead to unexpected data loss and other issues. If you are having persistent issues with sync, please report them to us at support@openlay.co.`,
  ...
  telemetryDesc: () =>
    t`Contribute towards a better OpenNotes. All tracking information is anonymous.`,
  ...
  emailSupportDesc: () =>
    t`Contact us directly via support@openlay.co for any help or support`,
  documentation: () => t`Documentation`,
  documentationDesc: () =>
    t`Read the documentation to learn more about OpenNotes`,
  ...
  joinMastodonDesc: () =>
    t`Follow us on Mastodon for updates and news about OpenNotes`,
  followOnX: () => t`Follow us on X`,
  followOnXDesc: () => t`Follow us on X for updates and news about OpenNotes`,
  ...
  ossLibs: () => t`Open source libraries used in OpenNotes`,
  about: () => t`About`,
  downloadOnDesktop: () => t`Download on desktop`,
  downloadOnDesktopDesc: () =>
    t`Get OpenNotes app on your desktop and access all notes`,
  roadmap: () => t`Roadmap`,
  roadmapDesc: () => t`See what the future of OpenNotes is going to be like.`,
  checkForUpdates: () => t`Check for updates`,
  checkForUpdatesDesc: () => t`Check for new version of OpenNotes`,
  ...
  subNotSupported: () =>
    t`This version of OpenNotes app does not support in-app purchases. Kindly login on the OpenNotes web app to make the purchase.`,
  ...
  backupSaved: (platform: string) =>
    select(platform, {
      android: 'Backup file saved in "OpenNotes backups" folder on your phone.',
      other: "Backup file is saved in File Manager/OpenNotes folder"
    }),
  ...
  backupDataDesc: () =>
    t`All your backups are stored in 'Phone Storage/OpenNotes/backups/' folder`,
  ...
  rateAppActionText: (platform: string) =>
    platform === "ios"
      ? t`Rate OpenNotes on App Store`
      : t`Rate OpenNotes on Play Store`,
  ...
  autoBackupsOffActionText: () =>
    t`Get OpenNotes Pro to enable automatic backups`,
  ...
  notificationsDisabledDesc: () =>
    t`Reminders cannot be set because notifications have been disabled from app settings. If you want to keep receiving reminder notifications, enable notifications for OpenNotes from app settings.`,
  openSettings: () => t`Open settings`,
  close: () => t`Close`,
  getOpenNotesPro: () => t`Get OpenNotes Pro`,
  colorsProMessage: () => t`Unlock more colors with OpenNotes Pro`,
  exportProMessage: () =>
    t`Export notes as PDF, Markdown and HTML with OpenNotes Pro`,
  tagsProMessage: () => t`Create unlimited tags with OpenNotes Pro`,
  notebookProMessage: () => t`Create unlimited notebooks with OpenNotes Pro`,
  vaultProMessage: () => t`Create unlimited vaults with OpenNotes Pro`,
...
- Things you have tried etc.`,
  ...
  savingNoteTakingTooLong: () =>
    t`Saving this note is taking too long. Copy your changes and restart the app to prevent data loss. If the problem persists, please report it to us at support@openlay.co.`,
  changesNotSavedDesc: () =>
  ...
  selectFolderForBackupFilesDesc: () =>
    t`Select folder where OpenNotes backup files are stored to view and restore them from the app`,
  ...
  installOpenNotes: () => t`Install OpenNotes`,
  installOpenNotesDesc: (platform: string) =>
    t`For a more integrated user experience, try out OpenNotes for ${platform}`,
  nativeFeatures: () => [
  ...
  importerHelpText: () => [
    ...
    t`import guide`,
    t`for help regarding how to use the OpenNotes Importer.`
  ],
  ...
  betaLoginNotice: () =>
    t`You are logging into the beta version of OpenNotes. Switching between beta &amp; stable versions can cause weird issues including data loss. It is recommended that you do not use both simultaneously.`,
  ...
  shareWithFriends: () => t`Share OpenNotes with friends!`,
  tagPromoWinText: () => [
    t`Use`,
    t`#opennotes`,
  ...
  backupFileMethodDesc: () =>
    t`If you don't have a recovery key, you can recover your data by restoring a OpenNotes data backup file (.nnbackup).`,
...
**Only use this for troubleshooting purposes. If you are having persistent issues, it is recommended that you reach out to us via support@openlay.co so we can help you resolve it permanently.**`,
  ...
  upgradeToProToUseFeature: (feature = "default") => {
    const features = {
      color: t`Upgrade to OpenNotes Pro to add colors.`,
      tags: t`Upgrade to OpenNotes Pro to create more tags.`,
      notebook: t` Upgrade to OpenNotes Pro to add more notebooks.`,
      vault: t` Upgrade to OpenNotes Pro to use the notes vault.`,
      customPresets: t` Upgrade to OpenNotes Pro to use custom toolbar presets.`,
      customizeToolbar: t` Upgrade to OpenNotes Pro to customize the toolbar.`,
      default: t` Upgrade to OpenNotes Pro to use this feature.`
    };
...
If your issue is critical (e.g. notes not syncing, crashes etc.), please [join our Discord community](https://discord.com/invite/zQBK97EE22) for one-to-one support.`,
  ...
  encryptsEverything: () =>
    t`OpenNotes encrypts everything offline before syncing to your other devices. This means that no one can read your notes except you. Not even us.`,
  ...
  welcomeToOpenNotesPro: () => t`Welcome to OpenNotes Pro`,
  thankYouPrivacy: () =>
  ...
  autoStartDescription: () =>
    t`If true, OpenNotes will automatically start up when you turn on & login to your system.`,
  startMinimized: () => t`Start minimized`,
  startMinimizedDescription: () =>
    t`If true, OpenNotes will start minimized to either the system tray or your system taskbar/dock. This setting only works with Auto start on system startup is enabled.`,
  ...
  opennotesImporter: () => t`OpenNotes Importer`,
  ...
  sourceCodeDescription: () =>
    t`All the source code for OpenNotes is available & open for everyone on GitHub.`,
  ...
  availableOnIOSDescription: () =>
    t`Get OpenNotes app on your iPhone and access all your notes on the go.`,
  availableOnIOSAndAndroidDescription: () =>
    t`Get OpenNotes app on your iPhone or Android device and access all your notes on the go.`,
  ...
  customDnsDescription: () =>
    t`OpenNotes uses the following DNS providers:

1. Cloudflare DNS
2. Quad9

This can sometimes bypass local ISP blockages on OpenNotes traffic. Disable this if you want the app to use system's DNS settings.`,
...
**These must only be used for troubleshooting. Using them regularly for sync is not recommended and will lead to unexpected data loss and other issues. If you are having persistent issues with sync, please report them to us at support@openlay.co.**`,
  ...
  usingOfficialInstance: () => t`Using official OpenNotes instance`,
  ...
  serversConfigurationDesc: () => t`Configure server URLs for OpenNotes`,
  ...
  releaseTrackDesc: () => t`Select the release track for OpenNotes.`,
  stable: () => t`Stable`,
  beta: () => t`Beta`,
  zoom: () => t`Zoom`,
  ...
  opennotesPlans: [() => t`OpenNotes`, () => t`Plans`],
  readyToTakeNextStep: () =>
  ...
  welcomeToPlan: (plan: string) => t`Welcome to OpenNotes ${plan}`,
  ...
  opennotesCircle: () => t`OpenNotes Circle`,
  opennotesCircleDesc: () =>
    t`OpenNotes Circle brings together trusted partners who share our commitment to privacy, transparency, and user freedom.`,
  trialUserCircleNotice: () =>
    `OpenNotes Circle is reserved for members with an active subscription. You'll get full access after your trial period is over and your subscription is confirmed.`,
  freeUserCircleNotice: () =>
    t`The OpenNotes Circle is exclusive to subscribers. Please consider subscribing to gain access to OpenNotes Circle and enjoy additional benefits.`,
  ...
  loginToUploadAttachments: () =>
    t`Login to upload attachments. [Read more](https://help.opennotes.openlay.com/faqs/login-to-upload-attachments)`,
  views: () => t`Views`,
