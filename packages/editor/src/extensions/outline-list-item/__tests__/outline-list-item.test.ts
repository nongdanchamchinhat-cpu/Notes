...
describe("outline list item", () => {
   ...
   * 1. Images were converted from inline nodes to block nodes (https://github.com/openlay/opennotes/pull/8563)
   * 2. Outline list item's `content` schema was changed from `paragraph + list?`  to `block+` to `paragraph block*` (https://github.com/openlay/opennotes/pull/8772 and https://github.com/openlay/opennotes/commit/0b943d8ecdf04fd7d996fd0a4b1d62ec9569f071)
   *
