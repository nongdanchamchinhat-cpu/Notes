...
import type { Config } from "@opennotes/clipper/dist/types";
      ...
      >
        ...
        <Button
          ...
          onClick={async () => {
            ...
            const opennotes = await connectApi(false);
            if (!opennotes) {
              setError("You are not connected to OpenNotes.");
              return;
            }
            await opennotes.saveClip({
              url,
              title,
              area: clipArea,
              mode: clipMode,
            ...
            await browser.notifications?.create({
              title: "Clip saved!",
              message: "Open the OpenNotes app to view the result.",
              type: "basic",
