...
const ACTION = {
  default_icon: ICONS,
  default_title: "OpenNotes Web Clipper",
  default_popup: "popup.html"
};

const nnHost =
  process.env.NODE_ENV === "production"
    ? "*://app.opennotes.openlay.com/*"
    : "*://localhost/*";
const v3nnHost = "*://v3.opennotes.openlay.com/*";
const corsHost = "https://cors.opennotes.openlay.com/*";
const common = {
  name: "OpenNotes Web Clipper",
  version,
  description:
    "Clip web pages & save interesting things you find on the web directly into OpenNotes in a private & secure way.",
...
const v2 = {
  ...
  browser_specific_settings: {
    gecko: {
      id: "opennotes-web-clipper-unlisted@opennotes.openlay.com",
