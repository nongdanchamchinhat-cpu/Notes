...
1. Go to [https://github.com/openlay/opennotes-themes](https://github.com/openlay/opennotes-themes) and "Fork" the repo. (Don't forget to "Star" it as well!)\
...
1. Go to your fork on GitHub. (Mine is at [https://github.com/ammarahm-ed/opennotes-themes](https://github.com/ammarahm-ed/opennotes-themes)).
