...
description: Create todo lists and manage your tasks in OpenNotes with ease using task lists.
---

# Task and todo lists

Create todo lists and manage your tasks in OpenNotes with ease using task lists.
...
OpenNotes supports unlimited subtasks under a single task item.
