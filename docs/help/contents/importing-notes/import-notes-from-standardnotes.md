...
3. Open the OpenNotes (app or desktop).
4. Go to `Settings > OpenNotes Importer` and select `Standard Notes` from list of apps.
...
6. Once importing completes you should see all your notes in OpenNotes. If you face any issues during importing, [report it on github](https://github.com/openlay/opennotes).
