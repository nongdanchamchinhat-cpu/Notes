...
6. Go to `Settings > OpenNotes Importer` and select `Zoho notebook` from the list of apps.
...
8. Once importing completes you should see all your notes in OpenNotes. If you face any issues during importing, feel free to [report them on GitHub](https://github.com/openlay/opennotes-importer).
