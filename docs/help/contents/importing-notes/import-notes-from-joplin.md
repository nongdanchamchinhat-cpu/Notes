...
3. Open the OpenNotes app (web or desktop)
4. Go to `Settings > OpenNotes Importer` and select `Joplin` from list of apps.
...
6. Once the importing completes you should see all your notes in OpenNotes. If you face any issues during importing, feel free to [report them on GitHub](https://github.com/openlay/opennotes-importer).
