---
title: Gift cards
description: Gift your friends and family a OpenNotes Pro subscription.
---

# Gift cards

Gift cards allow you to gift anyone a free OpenNotes Pro subscription. It's a simple 3-step process:
...
You can purchase a gift card from [https://opennotes.openlay.com/giftcards](https://opennotes.openlay.com/giftcards). There are 3 gift cards currently:
...
> info
>
> Gift cards are not attached to a user account and can be claimed by any OpenNotes user.

## Redeem a gift code

> info
>
> You can't redeem a gift code on an account with an active OpenNotes subscription. A cancelled subscription is still active until its current billing period ends.
...
Anyone who doesn't have a OpenNotes Pro subscription can redeem a gift code and upgrade their account. One user can only redeem a single gift code at a time.
