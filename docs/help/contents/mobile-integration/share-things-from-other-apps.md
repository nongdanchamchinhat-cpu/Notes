...
2. Select OpenNotes from the list of apps.

# [iOS](#/tab/ios)

![Select OpenNotes](/static/mobile-integration/select-opennotes-ios.png)

# [Android](#/tab/android)

![Select OpenNotes](/static/mobile-integration/select-opennotes-android.png)

---

3. Tap on the Save button on bottom right corner to save the web clip. This will save the web clip as a new note in OpenNotes.
...
1. Share the webpage link to OpenNotes share extension
