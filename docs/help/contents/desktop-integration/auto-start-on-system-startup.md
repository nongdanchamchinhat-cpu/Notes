...
If your workflow requires OpenNotes to be always opened, it's a good idea to enable auto start on system startup:
...
OpenNotes can also start minimized when it's opened on system startup:
